...
CentralityProvider::CentralityProvider(const edm::ParameterSet& topPset,edm::ConsumesCollector && iC) : //edm::EDGetTokenT<reco::Centrality> tag
   prevRun_(0),
   varType_(Missing)
{
  edm::ParameterSet hiPset = topPset.getParameter<edm::ParameterSet>("HeavyIonGlobalParameters");
