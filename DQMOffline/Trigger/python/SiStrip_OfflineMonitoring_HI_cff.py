...
HLTSiStripMonitorCluster.ClusterProducerStrip = cms.InputTag("hltHITrackingSiStripRawToClustersFacilityZeroSuppression")
HLTSiStripMonitorCluster.ClusterProducerPix   = cms.InputTag("hltHISiPixelClustersAfterSplitting")
...
hltTrackRefitterForSiStripMonitorTrack.MeasurementTrackerEvent = cms.InputTag('hltHISiStripClustersZeroSuppression') #not sure about this
...
hltTrackRefitterForSiStripMonitorTrack.src                     = cms.InputTag("hltHIPixelPairGlobalPrimTracksForGlobalPt8") # scenario 1, how was this particular iteration chosen replaced with our iter2 tracks which corresponds to pixel pair step
...
HLTSiStripMonitorTrack.Cluster_src       = cms.InputTag('hltHITrackingSiStripRawToClustersFacilityZeroSuppression')
